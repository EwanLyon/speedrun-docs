...
import { TwitchVideo as TwitchVideoElement } from "../components/twitch-video";
...
type TwitchURLData = {
	type: React.ComponentProps<typeof TwitchVideoElement>["type"];
	slug: string;
	startTime?: string;
} | null;
...
const plugin = (options: Plugin): Transformer => {
