...
import videoLinker from "./src/remark/video-linker";
		...
		[
			"classic",
			{
				docs: {
					...
					editUrl: `https://github.com/${speeddocsConfig.github.username}/${speeddocsConfig.github.projectName}/tree/main/`,
					remarkPlugins: [videoLinker],
				},
				blog: {
